    ...
    useEffect(() => {
        ...
        for (let i = 0; i < images.length - 1; i++) {
            setTimeout(() => {
                ...
                document.getElementById(`cube`).style.transform = `scale(1.5) rotateY(${rotation - 90}deg)`;
                document.getElementById(`cube`).style.transitionDuration = '400ms';
                setTimeout(() => {
                    document.getElementById(`cube`).style.transform = `scale(1.5) rotateY(${rotation}deg)`;
                    setTimeout(() => {
                        document.getElementById(`cube`).style.transform = `scale(2.5) rotateY(${rotation}deg)`;
                        rotation += 90
                    }, 500);
                }, 300);
            }, 1000 + (i * 2000));
